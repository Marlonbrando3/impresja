        ...
        <div className="lg:w-[1020px] w-[90%] mx-auto h-full flex- flex-col pt-[140px] pb-[120px] flex justify-between">
          <div className="flex flex-col justify-between h-[220px]">
            <div id="title" className="flex flex-col items-start md:w-[430px] h-[100px]">
              <div className="md:text-[70px] sm:text-[50px] text-[40px] text-white font-bold md:leading-[64px] leading-[34px] border">
                Osiedle Leśne
              </div>
              <div className="leading-[20px] text-white text-[24px] h-[30px] border">w Sycowie</div>
            </div>
            <div className="flex items-center">
              <div className="bg-white h-[2px] w-[40px] mr-[20px]"></div>
              <div
                className={`${TenorsSans.className} text-white w-[250px] min-h-[32px] font-bold leading-[18px] border`}
              >
